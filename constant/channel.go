...
const (
	...
	ChannelTypeCodex               = 57
	ChannelTypeImageRouter         = 58
	ChannelTypeRunware             = 59
	ChannelTypeVolcEngineAgentPlan = 60
...
var ChannelBaseURLs = []string{
	...
	"https://api.imagerouter.io",                //58
	"https://api.runware.ai",                    //59
	"https://ark.cn-beijing.volces.com",         //60
}
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeImageRouter:         "ImageRouter",
	ChannelTypeRunware:             "Runware",
	ChannelTypeVolcEngineAgentPlan: "VolcEngineAgentPlan",
}
